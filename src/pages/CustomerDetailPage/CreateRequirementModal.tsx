...
const CreateRequirementModal: React.FC<CreateRequirementModalProps> = ({ isOpen, onClose, storeId, createTask }) => {
    ...
    useEffect(() => {
        const fetchTaskDetails = async () => {
            try {
                const response = await axios.get(`http://ec2-51-20-32-8.eu-north-1.compute.amazonaws.com:8081/task/getByStoreAndDate?storeId=${storeId}&start=2024-06-01&end=2024-06-30`, {
                    headers: {
    ...
    const handleCreateTask = async () => {
        try {
            const response = await axios.post('http://ec2-51-20-32-8.eu-north-1.compute.amazonaws.com:8081/task/create', {
                ...newTask,
